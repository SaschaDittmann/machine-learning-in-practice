...
namespace TestDeployedRModels.Models
{
    ...
    public partial class BatchWebServiceResult
    {
        ...
        /// Initializes a new instance of the BatchWebServiceResult class.
        /// </summary>
        public BatchWebServiceResult(string state = default(string), int? completedItemCount = default(int?), int? totalItemCount = default(int?), int? parallelCount = default(int?), IList<WebServiceResult> batchExecutionResults = default(IList<WebServiceResult>))
        {
            State = state;
        ...
        /// <summary>
        /// Number of parallel threads that are processing this batch
        /// operation.
        /// </summary>
        [JsonProperty(PropertyName = "parallelCount")]
