...
namespace TestDeployedRModels
{
    ...
    /// <summary>
    /// </summary>
    public partial interface ICarsService : IDisposable
    {
        /// <summary>
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<WebServiceResult>> ManualTransmissionWithHttpMessagesAsync(InputParameters webServiceParameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
